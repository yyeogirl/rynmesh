...
case "${1:-}" in
  llm-runtime)
    ...
    export RYNMESH_TRANSFORMERS_CONTEXT="${RYNMESH_TRANSFORMERS_CONTEXT:-40960}"
    export RYNMESH_TRANSFORMERS_MAX_OUTPUT="${RYNMESH_TRANSFORMERS_MAX_OUTPUT:-32768}"
    export RYNMESH_TRANSFORMERS_TIMEOUT="${RYNMESH_TRANSFORMERS_TIMEOUT:-7200}"
  ...
  gateway)
    ...
    export RYNMESH_PROVIDER_TASK_TIMEOUT="${RYNMESH_PROVIDER_TASK_TIMEOUT:-7230}"
